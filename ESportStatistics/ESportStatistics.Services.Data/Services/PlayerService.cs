...
namespace ESportStatistics.Core.Services
{
    public class PlayerService : IPlayerService
    {
        ...
        public async Task<IPagedList<Player>> FilterPlayersAsync(string sortOrder = "", string filter = "", int pageNumber = 1, int pageSize = 10)
        {
            ...
            var query = this.dataContext.Players
