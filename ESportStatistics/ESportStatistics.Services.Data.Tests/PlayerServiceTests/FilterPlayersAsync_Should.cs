...
{
    [TestClass]
    public class FilterPlayersAsync_Should
    {
        [TestMethod]
        public async Task ThrowArgumentNullException_WhenPassedNullSortOrder()
        {
            ...
            await Assert.ThrowsExceptionAsync<ArgumentNullException>(
                () => SUT.FilterPlayersAsync(invalidSortOrder, validFilter, validPageNumber, validPageSize));
        }
        ...
        public async Task ThrowArgumentNullException_WhenPassedNullFilter()
        {
            ...
            // Act & Assert
            await Assert.ThrowsExceptionAsync<ArgumentNullException>(
                () => SUT.FilterPlayersAsync(validSortOrder, invalidFilter, validPageNumber, validPageSize));
        }
        ...
        public async Task ThrowArgumentOutOfRangeException_WhenPassedInvalidPageNumber(int invalidPageNumber)
        {
            ...
            await Assert.ThrowsExceptionAsync<ArgumentOutOfRangeException>(
                () => SUT.FilterPlayersAsync(validSortOrder, validFilter, invalidPageNumber, validPageSize));
        }
        ...
        public async Task ThrowArgumentOutOfRangeException_WhenPassedInvalidPageSize(int invalidPageSize)
        {
            ...
            // Act & Assert
            await Assert.ThrowsExceptionAsync<ArgumentOutOfRangeException>(
                () => SUT.FilterPlayersAsync(validSortOrder, validFilter, validPageNumber, invalidPageSize));
        }
    }
}
