...
namespace ESportStatistics.Services.Data.Tests.ItemServiceTests
{
    ...
    public class WithInMemory
    {
        ...
        [TestMethod]
        public async Task FindAsync_ShouldReturnItem_WhenPassedValidParameters()
        {
            // Arrange
            var contextOptions = new DbContextOptionsBuilder<DataContext>()
                .UseInMemoryDatabase(databaseName: "FindAsync_ShouldReturnItem_WhenPassedValidParameters")
                .Options;
